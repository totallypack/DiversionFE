...
import { createEvent, updateEvent, getEventById } from "../../managers/eventManager";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.errors) {
        ...
        setErrors([`Failed to ${isEditMode ? "update" : "create"} event. Please try again.`]);
      }
    }
  };

  const isLoading = loadingInterests || (isEditMode && loadingEvent);
